...
def upgrade() -> None:
    ...
    if 'activity_info' not in tables:
        op.create_table(
            'activity_info',
    ...
    if 'favorite_music' not in tables:
        op.create_table(
            'favorite_music',
    ...
    if 'member_session' not in tables:
        op.create_table(
            'member_session',
            sa.Column('member_id', sa.Integer(), nullable=False),
            sa.Column('channel_id', sa.Integer(), nullable=False),
...
def downgrade() -> None:
    ...
    op.drop_index(op.f('ix_favorite_music_user_id'), table_name='favorite_music')
