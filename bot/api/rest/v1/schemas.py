...
try:
    from api.rest.v1.tables import Member, Role, Emoji, ActivityInfo, \
        FavoriteMusic, SentMessage
except ModuleNotFoundError:
    from bot.api.rest.v1.tables import Member, Role, Emoji, ActivityInfo, \
        FavoriteMusic, SentMessage
