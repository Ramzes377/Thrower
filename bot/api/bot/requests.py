...
try:
    ...
    import os
    print(os.getcwd())
    from bot.api.rest.base import request
    from bot.api.rest.v1.dependencies import default_period
    from bot.api.bot.requests_meta import GettersWrapping
...
class BasicRequests(metaclass=GettersWrapping):
    ...
    async def update_leader(self, *, channel_id, member_id, begin,
                            update_sess=True) -> None:
