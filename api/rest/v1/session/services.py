        ...
        return (
            self._session.query(tables.Activity)
                ...
                .filter(tables.Session.begin <= tables.Activity.begin,
                        or_(tables.Session.end == None,
                            tables.Session.end >= tables.Activity.end))  # activity "inside" session
                ...
                .filter(tables.Prescence.begin <= tables.Activity.begin,
                        or_(tables.Prescence.end == None,
                            tables.Prescence.end >= tables.Activity.end))  # fetch only activity that "inside" prescence
        )
