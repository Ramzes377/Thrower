...
class SrvUser(CreateReadUpdate):
    ...
    def get_sessions(self, user_id: Specification, filters: BinaryExpression = None) -> list[Session]:
    ...
    def concrete_duration(self, member_id: Specification, role_id: Specification) -> IngameSeconds | None:
