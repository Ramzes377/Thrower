...
from .tools.mixins import BaseCogMixin, DiscordFeaturesMixin
from .tools.utils import get_app_id, user_is_playing, guild_id
    ...
    async def clear(self, interaction: discord.Interaction, n: int = 0) -> None:
        ...
        async for message in channel.history(limit=n + 1):
            try:
                ...
                pass
        await interaction.response.send_message(f'Успешно удалено {n} сообщений!',
                                                ephemeral=True, delete_after=30)
